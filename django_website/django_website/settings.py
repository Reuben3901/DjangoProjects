...
SECRET_KEY = 'upon)k8igt3*tw^#_t@-sz5wz6h#yt_^ke8&ygj3n2@c$=+^y8'
...
# EMAIL_PORT = 587
# EMAIL_USE_TLS = True
# EMAIL_HOST_USER = os.environ.get('Reubenwyoung@gmail.com')
# EMAIL_HOST_PASSWORD = os.environ.get('Arnold#3901')
